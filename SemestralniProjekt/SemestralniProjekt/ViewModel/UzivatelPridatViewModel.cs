...
{
    public class UzivatelPridatViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public Uzivatel UzivatelEditovany
        {
            get;
            set;
        }
        ...
        /// </summary>
        private Uzivatel uzivatelPuvodni;
        ...
        public UzivatelPridatViewModel(Uzivatel uzivatel, Databaze databaze, INavigation navigace)
        {
            ...
            this.UzivatelEditovany = new Uzivatel(uzivatel.Id, uzivatel.Jmeno);

            this.CommandPotvrzeni = new Command(PotvrzeniZmen);

            HlavniLabel = "Přidání uživatele";
        }
        ...
        protected async void PotvrzeniZmen()
        {
            ...
            this.uzivatelPuvodni.Jmeno = this.UzivatelEditovany.Jmeno;
            this.UzivatelEditovany = new Uzivatel();

            long idVlozenehoUzivatele = this.databaze.VlozUzivatele(this.uzivatelPuvodni);

            if (idVlozenehoUzivatele > 0)
            {
                this.uzivatelPuvodni.Id = idVlozenehoUzivatele;
                this.ProvedenoVlozeniUzivateleDoDatabaze?.Invoke(this.uzivatelPuvodni);
            }
